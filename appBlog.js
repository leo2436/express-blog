...
// 导入 route/blog_editing 的所有路由数据
const routeBlog = require('./route/blog_editing')
...
// 导入 route/detail.js 的所有路由数据
const routeDetail = require('./route/detail')
registerRoutes(app, routeDetail.routes)
